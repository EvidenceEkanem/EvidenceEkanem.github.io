...
<section class="bg-dark  mt-5">
    <footer class="container mb-5">
        ...
        <div class="d-flex justify-content-center align-item-center py-3">
            ...
            <a class="navbar-brand ml-2 font-weight-bold text-white" href="cardPost.php">BLOG</a>
        </div>

        <div>
            <p class="d-flex justify-content-center align-item-center text-white">Follow us on</p>
